...
<Cards>
  <Card
    ...
    description="No widgets, CSS, or component registry. Render fields with the design system you already have."
  />
  <Card
...
| **`@dimah-form/db`**     | Server      | Production persistence adapter using FumaDB for Drizzle, Prisma, and Kysely.                           | `DimahFormDB`, `db()`                                                   |
