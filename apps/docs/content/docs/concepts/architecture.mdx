...
<Callout>
  People usually get two things wrong: they look for a form renderer, and they expect submit to validate against the **live** questionnaire. Neither is true. You render. Submit uses the **snapshot** on that response.
</Callout>
