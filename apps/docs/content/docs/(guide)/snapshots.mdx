...
description: How definition snapshots guarantee schema immutability, safe drafts, and optimistic concurrency.
icon: Camera
---
...
<Cards>
  ...
  <Card
    ...
    href="/docs/database"
    description="Configure FumaDB with Drizzle or Prisma to store definition snapshots."
  />
</Cards>
