...
description: Author modular form schemas with defineForm, configure status, and leverage compile-time $Infer typing.
icon: FileText
---

In **dimah-form**, forms can be authored directly in TypeScript code using `defineForm()`, or created dynamically in your database via the `saveForm` API.
