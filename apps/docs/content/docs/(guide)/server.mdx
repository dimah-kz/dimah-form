...
description: Configure dimahForm(), mount HTTP route adapters across frameworks, and invoke form.api directly.
icon: Server
---

`@dimah-form/server` is the backend engine for Node.js, Bun, Deno, and Edge runtimes. It handles HTTP protocol routing, form definitions, snapshot freezing, security guards, and validation pipelines.
