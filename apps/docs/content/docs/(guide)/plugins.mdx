...
description: Extend dimah-form with custom HTTP endpoints, lifecycle hooks, error codes, and client companion methods.
icon: Puzzle
---

Plugins provide a modular way to extend **dimah-form** with **additive capabilities**: custom REST endpoints, lifecycle hooks, domain-specific error codes, and client convenience methods.
