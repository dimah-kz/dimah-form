---
title: Field Types & showWhen Reference
description: Built-in field types, validation constraints, conditional visibility rules, and $Infer type mappings.
icon: ListTree
---

**dimah-form** includes 7 built-in field types in `@dimah-form/core`. Each type defines a Zod definition schema, a server validation rule, and a TypeScript inference mapping.
