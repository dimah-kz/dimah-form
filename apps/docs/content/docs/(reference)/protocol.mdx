---
title: HTTP Protocol & Endpoints
description: Complete REST API specification for Form and Response endpoints, parameters, and payloads.
icon: Waypoints
---

All route paths, request payloads, and response schemas are defined in `@dimah-form/core`. The default endpoint base path is `/api/form`.
