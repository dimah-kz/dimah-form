...
const formFiles = [
  ...
  srcFile("components/dimah-form/field-input-group.tsx", "registry:component"),
  srcFile("components/dimah-form/choice-option.tsx", "registry:component"),
  ...
  srcFile("components/dimah-form/form-error-summary.tsx", "registry:component"),
  ...
  srcFile("hooks/use-session-error.ts", "registry:hook"),
  ...
  srcFile("lib/field-ui-meta.ts", "registry:lib"),
